        ...
        <div class="box-body" style="background-color:white;max-height: 450px; overflow-y: auto;" >
                <asp:GridView ID="gridData" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover fixed-headers" OnRowCommand="gridData_RowCommand">
                    <Columns>
                        ...
                        <asp:BoundField DataField="FechaSalida" HeaderText="Fecha Salida" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False" ItemStyle-Width="100px" />
                        <asp:BoundField DataField="FechaTentativa" HeaderText="Fecha Tentativa" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False" ItemStyle-Width="100px" />
                        <asp:BoundField DataField="FechaLlegada" HeaderText="Fecha Llegada" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False" ItemStyle-Width="100px" />
