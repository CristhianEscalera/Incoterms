<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="WebAdmBrand.aspx.cs" Inherits="SolucionesMedicasBilbaoWeb.WebAdmBrand" %>
...
<section class="content">
    <div class="row">
        <div class="col-md-3">
            <a class="btn btn-block btn-info btn-lg" href='WebNewBrand.aspx'>Agregar</a>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <asp:GridView ID="gridData" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover fixed-headers" OnRowCommand="gridData_RowCommand" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        <ItemTemplate>
                            <a class="square-button blue-button" href='WebUpdateBrand.aspx?id=<%#Eval("id")%>'><i class="fas fa-pencil-alt"></i></a>
