               ...
               <div class="card card-primary">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                       ...
                       <asp:TextBox ID="txtPrecio" MaxLength="8" runat="server" class="form-control required" placeholder="Ingrese el Precio" onkeypress="return validateInput(event, this);" onkeyup="removeExtraSpaces(this);">
                        </asp:TextBox>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <asp:TextBox ID="TxtMeasureUnit" MaxLength="12" runat="server" class="form-control required" placeholder="Ingrese la medida" onkeypress="validarNum(event)" onkeyup="removeExtraSpaces(this)" onblur="validateSpaces(this)"></asp:TextBox>
                        </div>
