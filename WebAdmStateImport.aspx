<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="WebAdmStateImport.aspx.cs" Inherits="SolucionesMedicasBilbaoWeb.WebAdmStateImport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a class="btn btn-block btn-info btn-lg" href='WebNewStateImport.aspx'>Agregar</a>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="box-body" style="background-color:white;max-height: 450px; overflow-y: auto;" >
                <asp:GridView ID="gridData" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover fixed-headers" OnRowCommand="gridData_RowCommand" >
                    <Columns>
                        ...
                        <asp:BoundField DataField="País" HeaderText="País"/>
                        <asp:BoundField DataField="Creado en:" HeaderText="Creado en:" />
                        <asp:TemplateField HeaderText="Acciones">
                            <ItemTemplate>
                                <a class="square-button blue-button" href='WebUpdateStateImport.aspx?id=<%#Eval("id")%>'><i class="fas fa-pencil-alt"></i></a>
