<%@ Page Title="Ad. User" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="WebAdmUser.aspx.cs" Inherits="SolucionesMedicasBilbaoWeb.WebAdmUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a class="btn btn-block btn-info btn-lg" href='WebNewUser.aspx'>Agregar</a>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="box-body" style="background-color:white;max-height: 450px; width:100%; overflow-y: auto; overflow-x: auto;" >
                <asp:GridView ID="gridData" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" OnRowCommand="gridData_RowCommand">
                    <Columns>
                        ...
                        <asp:BoundField DataField="Nombre Usuario" HeaderText="Usuario" />
                        <asp:BoundField DataField="Rol" HeaderText="Rol" />
                        <asp:BoundField DataField="Email" HeaderText="Email" />
                        <asp:BoundField DataField="Creado en:" HeaderText="Creado en:" />
                        <asp:TemplateField HeaderText="Acciones">
                            <ItemTemplate>
                                <a class="square-button blue-button" href='WebUpdateUser.aspx?id=<%#Eval("id")%>'><i class="fas fa-pencil-alt"></i></a>
