<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="WebNewBrand.aspx.cs" Inherits="SolucionesMedicasBilbaoWeb.WebNewBrand" %>
        ...
        <div class="box-body">
           <div class="card card-primary">
              <div class="card-header" style="background-color:#1B425E">
                <h3 class="card-title">Administracion Marca</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="card-body">
    ...
    <script>
        document.getElementById('<%= btnInsert.ClientID %>').onclick = function () {
            ...
            if (txtName.value.trim() === '') {
                ...
                txtDescriptionError.textContent = 'Ingrese Nombre de la marca';
