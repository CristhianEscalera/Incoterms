<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="WebAdmCountry.aspx.cs" Inherits="SolucionesMedicasBilbaoWeb.WebAdmCountry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a class="btn btn-block btn-info btn-lg" href='WebNewCountry.aspx'>Agregar</a>
            </div>
        </div>
        <br>
        <div class="row">
                ...
                <asp:GridView ID="gridData" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" OnRowCommand="gridData_RowCommand" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acciones">
                            <ItemTemplate>
                                <a class="square-button blue-button" href='WebUpdateCountry.aspx?id=<%#Eval("id")%>'><i class="fas fa-pencil-alt"></i></a>
